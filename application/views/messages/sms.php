...
<div class="col mb-3">
	...
	<div class="input-group">
		...
		<input type="text" name="phone" class="form-control" id="message-recipients" aria-describedby="message-icon" placeholder="<?= $this->lang->line('messages_phone_placeholder'); ?>">
	</div>
