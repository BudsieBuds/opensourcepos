			...
			?>
					<?= form_open("$controller_name/editItem/$line", ['class' => 'form-horizontal', 'id' => "cart_$line"]) ?>
						<tr>
							...
							<td><a href="javascript:$('#<?= esc("cart_$line", 'js') ?>').submit();" title=<?= lang(ucfirst($controller_name) .'.update') ?> ><i class="bi-arrow-repeat"></i></a></td>
						</tr>
						<tr>
							<?php
				...
				?>
					<?= form_open("$controller_name/requisitionComplete", ['id' => 'finish_receiving_form', 'class' => 'form-horizontal']) ?>
						<div class="form-group form-group-sm">
							...
							<div class="btn btn-sm btn-danger pull-left" id='cancel_receiving_button'><i class="bi-x-circle icon-spacing"></i><?= lang(ucfirst($controller_name) .'.cancel_receiving') ?></div>

							<div class="btn btn-sm btn-success pull-right" id='finish_receiving_button'><i class="bi-check-circle icon-spacing"></i><?= lang(ucfirst($controller_name) .'.complete_receiving') ?></div>
						</div>
					<?= form_close() ?>
				<?php
				}
