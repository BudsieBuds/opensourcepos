        ...
        <div class="col-12 col-lg-6">
            <div id="info-company_logo" class="w-100 fileinput <?= $logo_exists ? 'fileinput-exists' : 'fileinput-new'; ?>" data-provides="fileinput">
                ...
                <div type="button" class="btn btn-secondary btn-file me-2">
                    <span class="fileinput-new icon-link"><i class="bi bi-hand-index pe-1"></i><?= lang('Config.company_select_image') ?></span>
                    <span class="fileinput-exists icon-link"><i class="bi bi-images pe-1"></i><?= lang('Config.company_change_image') ?></span>
                    <input type="file" name="company_logo">
                </div>
                <button type="button" class="btn btn-outline-secondary icon-link fileinput-exists" data-dismiss="fileinput">
                    <i class="bi bi-eraser pe-1"></i><?= lang('Config.company_remove_image') ?>
                </button>
            </div>
        </div>
