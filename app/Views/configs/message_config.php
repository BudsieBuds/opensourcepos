    ...
    <div class="row">
        <div class="col-12 col-lg-6 mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="msg_uid" id="msg_uid" aria-describedby="msg-uid-icon" required value="<?= $config['msg_uid']; ?>">
            </div>
        </div>
        ...
        <div class="col-12 col-lg-6 mb-3">
            ...
            <div class="input-group">
                ...
                <input type="password" class="form-control" name="msg_pwd" id="msg_pwd" aria-describedby="msg-pwd-icon" required value="<?= $config['msg_pwd']; ?>">
            </div>
        </div>
        ...
        <div class="col-12 col-lg-6 mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="msg_src" id="msg_src" aria-describedby="msg-src-icon" required value="<?= $config['msg_src'] == null ? $config['company'] : $config['msg_src']; ?>">
            </div>
        </div>
    </div>
