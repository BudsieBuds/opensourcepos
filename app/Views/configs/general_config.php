...
<?= form_open('config/saveGeneral/', ['id' => 'general_config_form', 'enctype' => 'multipart/form-data']) ?>
    ...
    <div class="form-check form-switch mb-3">
        ...
        <div class="form-text"><i class="bi bi-info-square"></i>&nbsp;<?= lang('Config.enforce_privacy_tooltip') ?></div>
    </div>
    ...
    <div class="form-check form-switch mb-3">
        ...
        <div class="form-text"><i class="bi bi-info-square"></i>&nbsp;<?= lang('Config.gcaptcha_tooltip') ?></div>
    </div>
    ...
    <div class="form-check form-switch mb-3">
        ...
        <div class="form-text"><i class="bi bi-info-square"></i>&nbsp;<?= lang('Config.derive_sale_quantity_tooltip') ?></div>
    </div>
