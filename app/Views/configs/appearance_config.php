...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-binoculars"></i></label>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-view-stacked"></i></label>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<span class="input-group-text" id="color-mode-icon"><i class="bi-palette"></i></span>
		...
		<div class="row" id="notify_position">
			<div class="col-6 mb-3">
				<div class="input-group">
					<label class="input-group-text"><i class="bi-arrow-down-up"></i></label>
			...
			<div class="col-6 mb-3">
				<div class="input-group">
					<label class="input-group-text"><i class="bi-arrow-left-right"></i></label>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<span class="input-group-text" id="config-menu-position-icon"><i class="bi-distribute-horizontal"></i></span>
		...
		submitHandler: function(form) {
			$(form).ajaxSubmit({
				success: function(response) {
					$.notify( { icon: 'bi-bell-fill', message: response.message + '&nbsp;<em>Click to refresh.</em>', url: 'javascript:window.location.reload();', target: '_self'}, { type: response.success ? 'success' : 'danger'} )
				},
				dataType: 'json'
			});
		},
