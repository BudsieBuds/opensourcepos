...
<div class="d-flex gap-2 justify-content-end">
    <button type="button" class="btn btn-primary icon-link" data-btn-submit="<?= lang('Common.submit') ?>" data-href="<?= '$controller_name/view' ?>" title="<?= lang(ucfirst($controller_name). '.new') ?>">
        <i class="bi bi-person-add"></i><?= lang(ucfirst($controller_name) .".new") ?>
    </button>
...
<div id="toolbar">
    <div class="d-flex gap-2">
        <button type="button" class="btn btn-secondary icon-link">
            <i class="bi bi-trash"></i><span class="d-none d-sm-block"><?= lang('Common.delete') ?></span>
        </button>
        <button type="button" class="btn btn-secondary icon-link">
            <i class="bi bi-envelope"></i><span class="d-none d-sm-block"><?= lang('Common.email') ?></span>
        </button>
    </div>
</div>
