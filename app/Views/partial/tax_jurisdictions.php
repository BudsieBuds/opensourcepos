...
?>
    ...
    <div class="form-group form-group-sm" style="display: block;">
        ...
        <span class="add_tax_jurisdiction bi-plus-circle" style="padding-top: 0.5em; display: inline-block; cursor: pointer;"></span>
        <span>&nbsp;&nbsp;</span>
        <span class="remove_tax_jurisdiction bi-dash-circle" style="padding-top: 0.5em; display: inline-block; cursor: pointer;"></span>
