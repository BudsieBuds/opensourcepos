...
?>
    ...
    <div class="form-group form-group-sm" style="<?= $location_data['deleted'] ? 'display: none;' : 'display: block;' ?>">
        ...
        <span class="add_stock_location bi-plus-circle" style="padding-top: 0.5em; display: inline-block; cursor: pointer;"></span>
        <span>&nbsp;&nbsp;</span>
        <span class="remove_stock_location bi-dash-circle" style="padding-top: 0.5em; display: inline-block; cursor: pointer;"></span>
    </div>
