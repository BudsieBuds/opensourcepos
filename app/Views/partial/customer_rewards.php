...
?>
    ...
    <div class="form-group form-group-sm" style="<?= $reward_category['deleted'] ? 'display: none;' : 'display: block;' ?>">
        ...
        <span class="add_customer_reward bi-plus-circle" style="padding-top: 0.5em; display: inline-block; cursor: pointer;"></span>
        <span>&nbsp;&nbsp;</span>
        <span class="remove_customer_reward bi-dash-circle" style="padding-top: 0.5em; display: inline-block; cursor: pointer;"></span>
    </div>
