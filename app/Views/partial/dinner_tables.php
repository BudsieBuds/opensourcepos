...
?>
    ...
    <div class="form-group form-group-sm" style="<?= $table['deleted'] ? 'display: none;' : 'display: block;' ?>">
        ...
        <span class="add_dinner_table bi-plus-circle" style="padding-top: 0.5em; display: inline-block; cursor: pointer;"></span>
        <span>&nbsp;&nbsp;</span>
        <span class="remove_dinner_table bi-dash-circle" style="padding-top: 0.5em; display: inline-block; cursor: pointer;"></span>
    </div>
