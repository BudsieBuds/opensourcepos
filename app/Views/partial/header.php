...
<head>
	...
	<?php if (ENVIRONMENT == 'development' || get_cookie('debug') == 'true' || $request->getGet('debug') == 'true') : ?>
		...
		<link rel="stylesheet" href="resources/css/interface-c1077adb45.css">
		...
		<script src="resources/js/manage_tables-8ec147a2b5.js"></script>
	...
	<?php } ?>
		...
		<script src="resources/opensourcepos-189ce539d2.min.js"></script>
		<!-- endinject -->
	<?php endif; ?>
