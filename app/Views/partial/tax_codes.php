...
?>
    ...
    <div class="form-group form-group-sm" style="<?= $tax_code_data['deleted'] ? 'display:none;' : 'display:block;' ?>">
        ...
        <span class="add_tax_code bi-plus-circle" style="padding-top: 0.5em; display: inline-block; cursor: pointer;"></span>
        <span>&nbsp;&nbsp;</span>
        <span class="remove_tax_code bi-dash-circle" style="padding-top: 0.5em; display: inline-block; cursor: pointer;"></span>
