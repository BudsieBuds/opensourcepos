...
<div class="print_hide" id="control_buttons" style="text-align: right;">
    ...
    <?php if (isset($customer_email) && !empty($customer_email)): ?>
        <a href="javascript:void(0);">
            <div class="btn btn-info btn-sm" id="show_email_button"><?= '<i class="bi-envelope icon-spacing"></i>' . lang('Sales.send_quote') ?></div>
        </a>
    <?php endif; ?>
    <?= anchor('sales', '<i class="bi-cart2 icon-spacing"></i>' . lang('Sales.register'), ['class' => 'btn btn-info btn-sm', 'id' => 'show_sales_button']) ?>
    <?= anchor('sales/discardsuspendedsale', '<i class="bi-x-circle icon-spacing"></i>' . lang('Sales.discard'), ['class' => 'btn btn-danger btn-sm', 'id' => 'discard_quote_button']) ?>
</div>
