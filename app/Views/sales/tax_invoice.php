...
<div class="print_hide" id="control_buttons" style="text-align: right;">
    <a href="javascript:printdoc();">
        <div class="btn btn-info btn-sm" id="show_print_button"><?= '<i class="bi-printer icon-spacing"></i>' . lang('Common.print') ?></div>
    </a>
    <?php
    /* This line will allow to print and go back to sales automatically.
     * echo anchor('sales', '<i class="bi-printer icon-spacing"></i>' . lang('Common.print'), ['class' => 'btn btn-info btn-sm', 'id' => 'show_print_button', 'onclick' => 'window.print();'));
     */
    ?>
    <?php if (isset($customer_email) && !empty($customer_email)): ?>
        <a href="javascript:void(0);">
            <div class="btn btn-info btn-sm" id="show_email_button"><?= '<i class="bi-envelope icon-spacing"></i>' . lang('Sales.send_invoice') ?></div>
        </a>
    <?php endif; ?>
    <?= anchor("sales", '<i class="bi-cart2 icon-spacing"></i>' . lang('Sales.register'), ['class' => 'btn btn-info btn-sm', 'id' => 'show_sales_button']) ?>
    <?= anchor("sales/manage", '<i class="bi-receipt-cutoff icon-spacing"></i>' . lang('Sales.takings'), ['class' => 'btn btn-info btn-sm', 'id' => 'show_takings_button']) ?>
</div>

<div id="page-wrap">
    <div id="header"><?= lang('Sales.tax_invoice') ?></div>
    <div id="block1">
