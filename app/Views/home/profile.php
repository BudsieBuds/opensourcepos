    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" id="modal-button-logout" class="btn btn-danger icon-link" href="home/logout">
                    <i class="bi bi-power"></i><?= lang('Login.logout'); ?>
                </a>
                <button type="button" id="modal-button-save" class="btn btn-primary icon-link d-none">
